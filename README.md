...
Efficient learning from limited or undersampled data
...
Link: https://zenodo.org/records/7523691

Dataset Files

M4RawV1.1_multicoil_train.zip
Multicoil 3D MRI raw k-space data for training
...
Coil-wise handling and normalization

Reconstruction using learning-based or signal-processing techniques

Evaluation on validation scans
...
Original dataset authors for making the data publicly available

Open-source MRI research community
